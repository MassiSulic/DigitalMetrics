...
export class AppMenuComponent implements OnInit {
   ...
   constructor(public layoutService: LayoutService, private reportService: ReportesService, private usuariosService: UsuariosService, private tokenService: TokenService, private informesService: InformesService) {}
            ...
            ? [
                 {
                    ...
                    items: [
                       { label: 'Usuarios', icon: 'pi pi-fw pi-user', routerLink: ['/usuarios/lista'] },
